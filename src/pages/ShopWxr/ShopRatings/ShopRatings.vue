        ...
        <ul>
          <li class="rating-item" v-for="(rating,index) in filterRatings" :key="index">
            ...
            <div class="content">
              ...
              <div class="recommend">
                <span class="iconfont" :class="rating.rateType===0?'icon-zan':'icon-icon-thumb_down'"></span>
                <span class="item"  v-for="(food,index) in rating.recommend" :key="index">{{food}}</span>
              </div>
...
<script>
  ...
  import Star from '../../../components/StarWxr/StarWxr.vue'
      ...
      .rating-item
        ...
        .content
          ...
          .recommend
            line-height: 16px
            font-size: 0
            .icon-zan, .icon-icon-thumb_down, .item
              display: inline-block
              margin: 0 8px 4px 0
              font-size: 9px
            .icon-zan
